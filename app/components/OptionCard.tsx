...
const OptionCard: React.FC<OptionCardProps> = ({icon: Icon, name}) => {
    return (
        <div className="cursor-pointer w-fit group">
            <div className="flex-col flex border-white border-4 rounded-lg w-fit group-hover:scale-110 transition">
                <Icon size={200} className=""/>
                <div className="max-w-[200px] min-h-[4rem] flex-col flex justify-center border-t-4 border-black">
